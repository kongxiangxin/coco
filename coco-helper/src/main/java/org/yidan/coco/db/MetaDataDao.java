...
import org.yidan.coco.mapping.NamingStrategy;
import org.yidan.coco.mapping.TypeMapping;
import org.yidan.coco.meta.Column;
...
public class MetaDataDao {
    ...
    private void fillColumns(Table table) throws Throwable {
        ...
        Map<JDBCType, String> typeMapping = setting.getTypeMapping();
        while (rs.next()) {
            String column = rs.getString("COLUMN_NAME");
